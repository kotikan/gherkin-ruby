...
module GherkinRuby
  describe 'parses a directory of feature files' do
    ...
    it 'generates a nice tree' do
      ...
      first_feature = @result.features.first
      ...
      last_feature = @result.features.last
      ...
      last_feature_last_scenario = @result.features.last.scenarios.last
      last_feature_last_scenario.must_be_kind_of AST::Scenario
      last_feature_last_scenario.name.must_equal("No super coffee")

      first_feature_first_scenario_first_step = @result.features.first.scenarios.first.steps.first
      first_feature_first_scenario_first_step.must_be_kind_of AST::Step

      first_feature_first_scenario_last_step = @result.features.first.scenarios.first.steps.last
      first_feature_first_scenario_last_step.must_be_kind_of AST::Step

      first_feature_last_scenario_first_step = @result.features.first.scenarios.last.steps.first
      first_feature_last_scenario_first_step.must_be_kind_of AST::Step

      first_feature_last_scenario_last_step = @result.features.first.scenarios.last.steps.last
      first_feature_last_scenario_last_step.must_be_kind_of AST::Step

      last_feature_first_scenario_first_step = @result.features.last.scenarios.first.steps.first
      last_feature_first_scenario_first_step.must_be_kind_of AST::Step

      last_feature_first_scenario_last_step = @result.features.last.scenarios.first.steps.last
      last_feature_first_scenario_last_step.must_be_kind_of AST::Step

      last_feature_last_scenario_first_step = @result.features.last.scenarios.last.steps.last
      last_feature_last_scenario_first_step.must_be_kind_of AST::Step

      last_feature_last_scenario_last_step = @result.features.last.scenarios.last.steps.last
